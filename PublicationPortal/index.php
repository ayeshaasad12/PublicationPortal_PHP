    ...
    <div class="main-content">
            ...
            <div class="main_div">
                ...
                <div class="filter-section">
                    <select name="domain" id="domainFilter" class="custom-select">
                        ...
                        <option value="ComputerScience" <?php if ($filterDomain === 'ComputerScience') echo 'selected'; ?>>Computer Science</option>
        ...
        <div id="publicationList">
            <?php foreach ($publications as $publication): ?>
                <div class="card">
                    <div class="card-header"><b><?php echo $publication['DocumentTitle']; ?></b></div>
                    <div class="card-body">
                        ...
                        <button class="btn download-btn"  onclick="addBookmark('<?php echo $publication['documentfile']; ?>')">Add Bookmark</button>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
...
<script>
    ...
    function addBookmark(documentFile) {
        // Redirect to the PHP script that serves the file with appropriate headers
        window.location.href = "bookmark.php?file=" + encodeURIComponent(documentFile);
    }
